...
<nav class="dropdownmenu">
  <ul>
    ...
    <!-- <li> voir avec tab.php<a href="administration.php">ajouter un agent</a></li> -->
...
<form action="insertItem1.php" method="post" class="my-form">
  <div class="container">
    <!-- <h1>Get in touch!</h1> -->
   <ul>
      <li>
        ...
        <select for="itemDetailsItemNumber1" name="itemDetailsItemNumber1"id="itemDetailsItemNumber1">
         <option selected disabled>-- Please choose an centre --</option>
         <option class="form-control"  value="ALGER">ALGER</option>
         <option class="form-control"  value="CONSTANTINE">CONSTANTINE</option>
         <option class="form-control"  value="TIZI OUZOU">TIZI OUZOU</option>      
        </select>
      </li>
     ...
     <!-- <label for="itemDetailsQuantity3">nb_contrat<span class="requiredIcon">*</span></label>
      ...
      <li>
        <div class="grid grid-2">
          <input type="number" placeholder="code_agent" type="number" class="form-control"  name="itemDetailsItemName2" id="itemDetailsItemName2" required>  
          <input type="text" placeholder="nom_agent" class="form-control"  name="itemDetailsDiscount3" id="itemDetailsDiscount3" required>
        </div>
      </li>
      ...
      <li>
        ...
        <div class="grid grid-2">
          <input type="text" placeholder="prenom_agent"  class="form-control" name="itemDetailsQuantity4" id="itemDetailsQuantity4" required>  
          <!-- <input type="text" placeholder="poste" class="form-control" name="itemImageItemNumber5" id="itemImageItemNumber5" required> -->

          <select for="itemImageItemNumber5" name="itemImageItemNumber5"id="itemImageItemNumber5">
         <option selected disabled>-- poste --</option>
         <option class="form-control"  value="depouille">Agent depouille</option>
         <option class="form-control"  value="scan">Agent de scan</option>
         <option class="form-control"  value="saisie">Agent de saisie</option>
         <option class="form-control"  value="reception">Agent reception</option>
...
<!-- <label for="itemDetailsQuantity6">date_reception<span class="requiredIcon">*</span></label>
                                  ...
                                  <div class="grid grid-2">
          <!-- <input type="text" placeholder="etat" type="text" class="form-control" name="itemImageItemNumber6" id="itemImageItemNumber6" required>  -->

<select for="itemImageItemNumber6" name="itemImageItemNumber6"id="itemImageItemNumber6">
         ...
         <option class="form-control"  value="inactive">inactive</option>
          ...
          <input type="number" placeholder="num_cle" class="form-control" name="itemDetailsQuantity7" id="itemDetailsQuantity7" required>
                                          </div>

                                           <div class="grid grid-2">
          <input type="number" placeholder="num_puce" type="text" class="form-control" name="itemDetailsQuantity8" id="itemDetailsQuantity8" required>  
          <input type="text" placeholder="nom_user" class="form-control" name="itemImageItemNumber9" id="itemImageItemNumber9" required>
                                          </div>
<div class="grid grid-2">
          <input type="text" placeholder="mp" type="text" class="form-control" name="itemDetailsQuantity10" id="itemDetailsQuantity10" required>  
      ...
      <li>
        <div class="grid grid-3">
          ...
          <button class="btn-grid" type="button" id="addItem1" >
            <span class="back">
         ...
         <!--  <button class="btn-grid" type="button" id="addItem4" onclick="document.location.href='suis des lots.php'">
          ...
          <button class="btn-grid" type="reset">
            ...
            <span class="front" id="itemClear">RESET</span>
          </button> 
        </div>
      </li>    
    </ul>
