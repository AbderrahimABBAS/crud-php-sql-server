...
if(!empty($nb_recu) && !empty($nb_traite) && isset($nb_rejete)&& !empty($date_affectaion)&& !empty($date_restitution)){
...
// $query = "UPDATE dbo.[traitement]  set nb_recu='$nb_recu', nb_traite='$nb_traite',nb_rejete='$nb_rejete', date_affectaion='$date_affectaion',date_restitution='$date_restitution' where num_boite='$num_boite'";
	     ...
	     $query = "UPDATE dbo.[saisie]  set code_centre='$i',code_agent='$j',nb_recu='$nb_recu', nb_traite='$nb_traite',nb_rejete='$nb_rejete', date_affectaion='$date_affectaion',date_restitution='$date_restitution'where num_boite='$numbt' ";
