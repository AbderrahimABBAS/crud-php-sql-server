...
console.log("characterInput");
	...
	// Listen to item administration add button
	...
	// Listen to item depouille add button
...
// Listen to item depouille add button
	$('#addItemD').on('click', function(){
		addItemD();
			console.log("characterInput1");

	});
	// Listen to item Saisie add button
	$('#update1S').on('click', function(){
		update1S();
			console.log("characterInput1");
	...
	// Listen to item depouille add button
	$('#prendre1UD').on('click', function(){
		prendre1UD();
			console.log("characterInput1");

	});
	// Listen to item depouille add button
	$('#remise1UD').on('click', function(){
		remise1UD();
			console.log("characterInput1");
	...
	// Listen to item 
	$('#prendre1USAI').on('click', function(){
		prendre1USAI();
			console.log("characterInput1");
	...
	// });
	// Listen to item Scain add button
	$('#addItemSc').on('click', function(){
		addItemSc();
			console.log("characterInput1");

	});
	// Listen to item Scain add button
	$('#update1Sc').on('click', function(){
		updateSc();
			console.log("characterInput1");
...
// Function to call the insertItem.php script to insert item data to db ::itemDetailsQuantity1
function addItem() {
	var itemDetailsItemName1 = $('#itemDetailsItemName1').val();
    var itemDetailsDiscount = $('#itemDetailsDiscount').val();
	var itemDetailsQuantity = $('#itemDetailsQuantity').val();
	console.log("charaSUIT DL");
	$.ajax({
		url: 'model/item/insertItem.php',
		method: 'POST',
		data: {
			itemDetailsItemName1:itemDetailsItemName1,
...
// Function to call the insertItem1.php script to insert item data to db ::itemDetailsQuantity1
function addItem1() {
     	...
     	success: function(msg){ // si l'appel a bien fonctionné
						if(msg==1) // si la connexion en php a fonctionnée
						{
							// window.location.assign("membre/profile.php");
								console.log("connection fonctione");

						}
						else // si la connexion en php n'a pas fonctionnée
						{
							console.log("connection ne fonctione");
						}
				   },
		success: function(data){
			$('#itemDetailsMessage').fadeIn();
...
function addItem2() {
	...
	console.log("characterInput2");
	console.log( itemDetailsQuantity11);
	$.ajax({
		url: 'insertItem2.php',
		method: 'POST',
		data: {
...
function updateSc() {
	...
	var nb_recu = $('#nb_recu').val();
	var nb_traite = $('#nb_traite').val();
	var nb_rejete = $('#nb_rejete').val();
	var date_affectaion = $('#date_affectaion').val();
	var date_restitution = $('#date_restitution').val();
	...
	$.ajax({
		...
		data: {
			...
			nb_traite:nb_traite,
			nb_rejete:nb_rejete,
			date_affectaion:date_affectaion,
...
function prendre1UD() {
	...
	// $('#prbt').fadeIn();
	// $('#prbt').html("Boite prise");
	// document.getElementById("prbt").innerHTML = "Boite prise";
	var nb_recu = $('#nb_recu').val();
	var nb_traite = $('#nb_traite').val();
	var nb_rejete = $('#nb_rejete').val();
	var date_affectaion = $('#date_affectaion').val();
	...
	$.ajax({
		...
		success: function(data){
			// document.getElementById("prbt").innerHTML = "Boite prise";
			 ...
			 // var x = document.getElementById("prbt");
    //          if (x.innerHTML === "Prendre la boite") {
    //          x.innerHTML = "Boite prise";
    //          } 
    //          // else {
    //          // x.innerHTML = "Hello";
    //          //              }
...
function addItem3() {
	...
	var itemDetailsItemNumber1 = $('#itemDetailsItemNumber1').val();
	var itemDetailsItemName2 = $('#itemDetailsItemName2').val();
	var itemDetailsQuantity3 = $('#itemDetailsQuantity3').val();
	var itemImageItemNumber4 = $('#itemImageItemNumber4').val();
	var itemImageItemNumber5 = $('#itemImageItemNumber5').val();
	var itemDetailsQuantity6 = $('#itemDetailsQuantity6').val();
	var itemDetailsQuantity7 = $('#itemDetailsQuantity7').val();
	
	console.log("characterInput2");
	
	$.ajax({
		url: 'insertItem3BV.php',
		method: 'POST',
		data: {
			taskOption:taskOption,
			itemDetailsItemNumber1:itemDetailsItemNumber1,
			itemDetailsItemName2:itemDetailsItemName2,
			itemDetailsQuantity3:itemDetailsQuantity3,
			itemImageItemNumber4:itemImageItemNumber4,
			itemImageItemNumber5:itemImageItemNumber5,
			itemDetailsQuantity6:itemDetailsQuantity6,
			itemDetailsQuantity7:itemDetailsQuantity7,
...
// 	window.location.href = ("suis des lots.php");
...
// 	window.location.href = ("suis des lots.php");onclick="document.location.href='suis des lots.php'"
