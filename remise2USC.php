...
$req = "SELECT * FROM dbo.[scan] WHERE num_boite='$numbt'and num_lot='$numbt3'and code_centre='$numbt1'and code_dr_interne='$numbt2'"; 
...
$query = "UPDATE dbo.[scan]  set nb_rejete='$nb_rejete',nb_traite='$nb_traite', date_restitution='$date_restitution'where num_boite='$numbt'and code_centre='$numbt1'and code_dr_interne='$numbt2'and num_lot='$numbt3'and code_agent='$j'";
// $datta = sqlsrv_query($conn,$req);
