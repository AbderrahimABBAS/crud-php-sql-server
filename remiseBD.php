...
$requete5 = htmlentities($_GET['code_dr_interne']);
        ...
        $req = "SELECT * FROM dbo.[depouille] WHERE num_boite='$requete'AND num_lot='$requete1'AND code_centre='$requete4'AND code_dr_interne='$requete5'"; 
...
<form action="remise1UD.php" method="POST">
...
<input type="hidden" name="nb_recu" value=<?php echo $_GET['nb_recu'];?>>

<button type="submit" class="btn" id="remise1UD">Update Content</button>
