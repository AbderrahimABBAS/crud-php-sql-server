...
$requete5 = htmlentities($_GET['code_dr_interne']);
        ...
        $req = "SELECT * FROM dbo.[saisie] WHERE num_boite='$requete'AND num_lot='$requete1'AND code_centre='$requete4'AND code_dr_interne='$requete5'"; 
...
<form action="remise2USAI.php" method="POST">
...
<button type="submit" class="btn" id="remise2USAI">Update Content</button>
