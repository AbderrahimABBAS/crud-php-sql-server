...
if(!empty($nb_recu) && !empty($nb_traite) && !empty($nb_rejete)&& !empty($date_affectaion)&& !empty($date_restitution)){
...
//        // $_SESSION['id'] = $row['id'];code_centre
//        // $_SESSION['name'] = $row['name'];code_agent
//        // $_SESSION['user'] = $row['user'];
//        // $_SESSION['level'] = $row['level'];
//           $i = $row['code_centre'];
//           $j = $row['code_agent'];
//           // echo $row['code_agent'];
//           // echo $row['code_centre'];
...
// echo $j;
   if (!$result) {
	     ...
	     $query = "UPDATE dbo.[traitement]  set code_centre='$i',code_agent='$j',nb_recu='$nb_recu', nb_traite='$nb_traite',nb_rejete='$nb_rejete', date_affectaion='$date_affectaion',date_restitution='$date_restitution'where num_boite='$numbt' ";
