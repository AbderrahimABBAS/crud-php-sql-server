...
if(!empty($date_affectaion)){
	     ...
	     // echo"hello2"; ajouter autre condition nom agent prenon agent
/////////////////////////////////////////
...
// on met insert ici pas update
 ...
 $query =  "INSERT INTO dbo.[scan]([num_boite],[code_centre],[num_lot],[code_dr_interne],[code_agent],[nb_recu],[date_affectaion])
                                           VALUES('$numbt','$numbt1','$numbt3', '$numbt2','$j','$numbt4','$date_affectaion')";
                                                    
	     // $query = "UPDATE dbo.[scan]  set code_centre='$numbt1',num_lot='$numbt3',code_dr_interne='$numbt2',code_agent='$j',nb_recu='$numbt4', date_affectaion='$date_affectaion'where num_boite='$numbt' ";
...
if($data)
{
    echo"<script>alert('Record Updated')<script>";
     ...
     echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>Item added to database.</div>';
        ...
        //il faut un sleep time ici 
        header("Location: traitement2.php");
   }
}
