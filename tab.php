...
<nav class="dropdownmenu">
  <ul>
    ...
    <li><a href="tab.php">ajouter un agent</a></li>
   ...
   <ul>
      <li>
        ...
        <select for="itemDetailsItemNumber1" name="itemDetailsItemNumber1"id="itemDetailsItemNumber1">
         ...
         <option class="form-control"  value="SUD">TIZI OUZOU</option>      
        </select>
      </li>
     ...
     <!-- <label for="itemDetailsQuantity3">nb_contrat<span class="requiredIcon">*</span></label>
      ...
      <li>
        ...
        <div class="grid grid-2">
          <input type="text" placeholder="prenom_agent" type="text" class="form-control" name="itemDetailsQuantity4" id="itemDetailsQuantity4" required>  
