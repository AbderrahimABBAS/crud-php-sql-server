...
////////////////////////////////////////////////////////
    // $query2 = "SELECT * FROM dbo.[depouille] WHERE num_boite='$numbt'and code_centre='$numbt1'and code_dr_interne='$numbt2' and num_lot='$numbt3'";
...
//     }
    /////////////////////////////////////////////////////////////////////
	    ...
	    $query =  "INSERT INTO dbo.[depouille]([num_boite],[code_centre],[num_lot],[code_dr_interne],[code_agent],[nb_recu],[date_affectaion])
